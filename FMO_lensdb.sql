...
INSERT INTO `lens` (`id`, `part_no`, `name`, `no`, `diameter`, `BC`, `powerL`, `powerH`, `water`, `daily`, `biweekly`, `monthly`, `place_of_prod`, `price`, `package`, `special_price`, `event_disp`, `license`, `new_tag`, `hotsale_tag`, `onsale_tag`, `create_at`, `launch_at`, `remove_at`, `update_at`, `url`, `state`) VALUES
	(0, 'JK7890', '栗子蒙布朗', NULL, 1.3, 17, 1000, 1500, 50, 1, 0, 1, '泰國', 2000, 3, NULL, NULL, 'L78910', 0, 1, 0, '2019-09-13', '1999-09-07', '2019-10-06', '2019-09-30', '/lensPic/JK7890.png', 0),
	...
	(2, '38', '星空灰', 0, 15, 17, 500, 600, 20, 1, 1, 0, '台灣', 3000, 10, 2500, '開幕優惠', 'L12345', 1, 0, 1, '2019-09-13', '2019-09-17', '2019-09-24', '2019-09-30', '/lensPic/38.png', 2),
	(3, '39', '星空棕', 8, 15, 17, 500, 1000, 20, 1, 0, 0, '台灣', 3500, 10, 2500, '開幕優惠', 'L12345', 1, 1, 1, '2019-09-13', '2019-10-16', '2019-12-02', '2019-09-30', '/lensPic/39.png', 0),
	(4, '42', '甜心灰', NULL, 13, 17.5, 100, 500, 50, 0, 1, 0, '巴西', 200, 13, 150, '開幕優惠', 'L78910', 1, 1, 1, '2019-09-13', '2019-09-01', '2019-09-21', '2019-09-30', '/lensPic/42.png', 2),
	(5, 'KK', '楓糖奶茶', 3, 10.5, 7, 900, 1000, 24, 1, 0, 0, '美國', 400, 30, NULL, NULL, 'B333777', 1, 1, 0, '2019-09-13', '2019-09-14', '2019-10-03', '2019-09-30', '/lensPic/44.png', 1),
	(6, 'JK678', '馬卡龍灰', 7, 2, 5, 400, 800, 7, 0, 1, 0, '紐西蘭', 2000, 10, NULL, NULL, 'LH333', 1, 0, 0, '2019-09-29', '2019-09-16', '2019-10-30', '2019-09-30', '/lensPic/JK678.png', 1),
	...
	(8, '46', '幕斯可可', 5, 13, 10, 50, 100, 20, 1, 0, 0, '北極', 3000, 3, NULL, NULL, 'K123456', 0, 1, 0, '2019-09-13', '2019-09-28', '2019-10-22', '2019-09-30', '/lensPic/46.png', 1),
	(9, '33333', '黑醋栗摩卡', 7, 30, 35, 50, 200, 3, 1, 0, 0, '荷蘭', 300, 10, NULL, NULL, 'L4444', 0, 1, 0, '2019-09-29', '2019-09-22', '2019-10-07', '2019-09-30', '/lensPic/33333.png', 1),
	(13, 'KT789', '黑森林', 7, 15.6, 20.1, 50, 100, 30, 1, 1, 1, '土耳其', 300, 3, NULL, NULL, 'TT666', 1, 1, 0, '2019-09-30', '2019-09-20', '2019-10-22', '2019-09-30', '/lensPic/KT789.png', 1);

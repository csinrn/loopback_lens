...
INSERT INTO `lens` (`part_no`, `name`, `no`, `diameter`, `BC`, `powerL`, `powerH`, `water`, `daily`, `biweekly`, `monthly`, `place_of_prod`, `price`, `package`, `special_price`, `event_disp`, `license`, `new_tag`, `hotsale_tag`, `onsale_tag`, `create_at`, `launch_at`, `remove_at`, `url`, `state`) VALUES
	('38', '星空灰', NULL, 15, 17, 500, 600, 20, 1, 1, 0, '台灣', 3000, 10, 2500, '開幕優惠', 'L12345', 1, 0, 1, '2019-09-13', '2019-10-29', '2019-11-19', '/lensPic/38.png', 0),
	('39', '星空棕', NULL, 15, 17, 500, 1000, 20, 1, 0, 0, '台灣', 3500, 10, 2500, '開幕優惠', 'L12345', 1, 1, 1, '2019-09-13', '2019-10-20', '2019-12-02', '/lensPic/39.png', 0),
	('40', '香檳金', 2, 13, 17, 0, 50, 50, 1, 0, 1, '馬來西亞', 200, 10, 150, '打折', 'L78910', 0, 0, 1, '2019-09-13', '2019-08-30', '2020-10-03', '/lensPic/40.png', 1),
	('41', '栗子蒙布朗', NULL, 13, 17, 1000, 1500, 50, 1, 0, 1, '馬來西亞', 2000, 3, NULL, NULL, 'L78910', 0, 1, 0, '2019-09-13', '1999-09-13', '2019-10-06', '/lensPic/41.png', 0),
	('42', '甜心灰', NULL, 13, 17, 100, 500, 50, 0, 1, 0, '巴西', 200, 1, NULL, NULL, 'L78910', 1, 0, 0, '2019-09-13', '2019-09-01', '2019-09-22', '/lensPic/42.png', 2),
	('44', '楓糖奶茶', NULL, 10, 7, 900, 1000, 24, 1, 0, 0, '美國', 400, 30, NULL, NULL, 'B333777', 1, 1, 0, '2019-09-13', '2019-09-14', '2019-10-03', '/lensPic/44.png', 2),
	('45', '焦糖布蕾', 0, 20, 6, 100, 200, 10, 1, 0, 0, '日本', 700, 20, NULL, NULL, 'B34567', 0, 1, 0, '2019-09-13', '2019-09-29', '2019-10-03', '/lensPic/45.png', 1),
	('46', '幕斯可可', 1, 13, 10, 50, 100, 20, 1, 0, 0, '北極', 3000, 3, NULL, NULL, 'K123456', 0, 1, 0, '2019-09-13', '2019-09-28', '2019-10-01', '/lensPic/46.png', 1),
	('JK678', '馬卡龍灰', 4, 2, 5, 400, 800, 7, 0, 1, 0, '紐西蘭', 2000, 10, NULL, NULL, 'LH333', 1, 0, 0, '2019-09-29', '2019-09-16', '2019-10-30', '/lensPic/JK678.png', 1),
	('LK333', '黑醋栗摩卡', 3, 30, 35, 50, 200, 3, 1, 0, 0, '荷蘭', 300, 10, NULL, NULL, 'L3333', 0, 1, 0, '2019-09-29', '2019-09-22', '2019-10-08', '/lensPic/LK333.png', 1);

...
INSERT INTO `lens` (`part_no`, `name`, `no`, `diameter`, `BC`, `powerL`, `powerH`, `water`, `daily`, `biweekly`, `monthly`, `place_of_prod`, `price`, `package`, `special_price`, `event_disp`, `license`, `new_tag`, `hotsale_tag`, `onsale_tag`, `create_at`, `launch_at`, `remove_at`, `url`, `state`) VALUES
	...
	('39', '星空棕', NULL, 15, 17, 500, 1000, 20, 1, 0, 0, '台灣', 3500, 10, 2500, '開幕優惠', 'L12345', 1, 1, 1, '2019-09-13', '2019-10-20', '2019-11-30', '/lensPic/星空棕.png', 0),
	('40', '香檳金', NULL, 13, 17, 0, 50, 50, 1, 0, 1, '馬來西亞', 200, 10, 150, '打折', 'L78910', 0, 0, 1, '2019-09-13', '2019-12-30', '2020-09-29', '/lensPic/香檳金.png', 0),
	('41', '栗子蒙布朗', NULL, 13, 17, 1000, 1500, 50, 1, 0, 1, '馬來西亞', 2000, 3, NULL, NULL, 'L78910', 0, 1, 0, '2019-09-13', '1999-09-13', '2019-09-27', '/lensPic/栗子蒙布朗.png', 0),
	('42', '甜心灰', NULL, 13, 17, 100, 500, 50, 0, 1, 0, '巴西', 200, 1, NULL, NULL, 'L78910', 1, 0, 0, '2019-09-13', '2019-09-01', '2019-09-22', '/lensPic/甜心灰.png', 2),
	('43', '馬卡龍灰', NULL, 10, 7, 900, 1000, 24, 0, 1, 0, '印度', 900, 30, 500, '情人節促銷活動', 'L78910', 1, 0, 1, '2019-09-13', '2019-09-01', '2019-09-02', '/lensPic/馬卡龍灰.png', 2),
	('44', '楓糖奶茶', NULL, 10, 7, 900, 1000, 24, 1, 0, 0, '美國', 400, 30, NULL, NULL, 'B333777', 1, 1, 0, '2019-09-13', '2019-09-14', '2019-09-29', '/lensPic/楓糖奶茶.png', 2),
	('45', '焦糖布蕾', 1, 20, 6, 100, 200, 10, 1, 0, 0, '日本', 700, 20, NULL, NULL, 'B34567', 0, 1, 0, '2019-09-13', '2019-09-29', '2019-09-30', '/lensPic/焦糖布蕾.png', 1),
	('46', '幕斯可可', 0, 13, 10, 50, 100, 20, 1, 0, 0, '北極', 3000, 3, NULL, NULL, 'K123456', 0, 1, 0, '2019-09-13', '2019-09-28', '2019-10-01', '/lensPic/幕斯可可.png', 1);
